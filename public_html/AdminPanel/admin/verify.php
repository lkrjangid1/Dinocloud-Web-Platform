	...
	if($stmt->rowCount() > 0)
	{
		if($row['userStatus']==$statusN)
		{
			...
			$msg = "
				   ...
				   <button class='close' data-dismiss='alert'>&times;</button>
					  <strong>Congratulation! Your account is now Activated: </strong><a href='index.php'>Login HERE</a>
			       </div>
			       ";	
		}
		else
		{
			$msg = "
				   ...
				   <button class='close' data-dismiss='alert'>&times;</button>
					  <strong>We're sorry! Your account is already Activated: </strong><a href='index.php'>Login here</a>
			       </div>
			       ";
		}
	}
